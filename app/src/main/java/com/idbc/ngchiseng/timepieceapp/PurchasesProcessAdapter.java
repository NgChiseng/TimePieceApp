...
public class PurchasesProcessAdapter extends BaseAdapter {
    ...
    static class ViewHolder {
        ...
        private TextView tabItemType;
        private TextView tabItemPaymentDate;
    }
    ...
    /*  Method that create the AnnouncesAdapter's object(constructor).
           ...
           @return [void]
   */
    public PurchasesProcessAdapter(Context context, int idListLayout, ArrayList<Announce> entries){
        super();
   ...
   */
    ...
    public View getView(int position, View view, ViewGroup parent){
        ...
        String text1 =  actualEntry.getPriceComplete() +  "," + actualEntry.getQuantity() + " Adquisiciones";
        holder.tabItemPrice.setText(text1);
        holder.tabItemType.setText(actualEntry.getType());
        String text2 = "Fecha de Pago: " + actualEntry.getFirstDate();
        holder.tabItemPaymentDate.setText(text2);
        return view;
