...
public class PublicationDonationsEditionActivity extends AppCompatActivity implements View.OnClickListener {

    /* This will define the variables that will use in the creation of the donation */
    private ImageView donationImage;
    private EditText donationTitle, donationDescription;
    private TextView donationRequired, donationCollected;
    private Button donationBtn;

    private static final int REQUEST_CAMERA = 0;
    private static final int SELECT_FILE = 1;

    /*  Method that will onCreate of the PublicationDonationsEdition activity, link its component, and implements the
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_publication_donations_edition);
        ...
        */
        ...
        String collected = (String) intent.getExtras().get("Collected");
        ...
        donationImage = (ImageView) findViewById(R.id.edit_donation_image);
        donationTitle = (EditText) findViewById(R.id.edit_donation_title);
        donationRequired = (TextView) findViewById(R.id.edit_donation_raise);
        donationCollected = (TextView) findViewById(R.id.edit_donation_collected);
        donationDescription = (EditText) findViewById(R.id.edit_donation_description);
        donationBtn = (Button) findViewById(R.id.edit_donation_button);

        /* This will set the actual values in the moment, without the modification. */
        donationImage.setImageResource(imageId);
        donationTitle.setText(title);
        donationRequired.setText(required);
        donationCollected.setText(String.format(res.getString(R.string.donation_edit_collected), collected));
        donationDescription.setText(description);
    ...
    */
    ...
    public void onClick(android.view.View v) {
        if (v.getId() == R.id.edit_donation_button) {
            Toast.makeText(this, "Click Edit donation", Toast.LENGTH_LONG).show();

        } else if (v.getId() == R.id.edit_donation_image) {
