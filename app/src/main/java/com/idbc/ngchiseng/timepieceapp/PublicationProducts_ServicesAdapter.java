...
public class PublicationProducts_ServicesAdapter extends BaseAdapter {
    ...
    /*  Method that create the AnnouncesAdapter's object(constructor).
           ...
           @return [void]
   */
    public PublicationProducts_ServicesAdapter(Context context, int idListLayout, ArrayList<Announce> entries){
        super();
   ...
   */
    ...
    public View getView(int position, View view, ViewGroup parent){
        ...
        String text1 =  "Fecha Creacion: " + actualEntry.getFirstDate();
        holder.tabItemPrice.setText(actualEntry.getPriceComplete());
        holder.tabItemFirstDate.setText(text1);
        String text2 = "Fecha de Modificacion: " + actualEntry.getSecondDate();
