...
public class PurchasesDoneAdapter extends BaseAdapter {
    ...
    /*  Method that create the AnnouncesAdapter's object(constructor).
           ...
           @return [void]
   */
    public PurchasesDoneAdapter(Context context, int idListLayout, ArrayList<Announce> entries){
        super();
   ...
   */
    ...
    public View getView(int position, View view, ViewGroup parent){
        ...
        String text2 = "Fecha de Cierre: " + actualEntry.getFirstDate();
